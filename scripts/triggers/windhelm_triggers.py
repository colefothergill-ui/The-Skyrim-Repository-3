...
def windhelm_location_triggers(player_location, campaign_state):
    ...
    if "windhelm" in loc_normalized:
        ...
        if "stone quarter" in loc_normalized or ("market" in loc_normalized and "windhelm" in loc_normalized):
